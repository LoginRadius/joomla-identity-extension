...
/**
 * Script file of CiamLoginRadius component
 */

class Com_CiamLoginRadiusInstallerScript
{
    /**
     * 
     * @param type $type
    ...
    public function install($parent)
    {
        ...
        $isUpdate = JFile::exists(JPATH_SITE . DS . 'modules' . DS . 'mod_ciam' . DS . 'mod_ciam.php');
        ...
        $lang->load('com_ciamloginradius', JPATH_SITE);
        // Installing modules.
    ...
    private function installationResults($status)
    {
        ...
        {
            ?>
            <h2><?php echo JText::_('COM_CIAM_INSTALLATION_TITLE'); ?></h2>
            <table class="adminlist table table-striped">
                ...
                <tbody>
                    ...
                    <tr class="row0">
                        <td class="key" colspan="2"><?php echo JText::_('COM_CIAM_INSTALLATION_MODULE') . JText::_('Component'); ?></td>
            ...
            <h2><?php echo JText::_('COM_CIAM_INSTALLATION_STATUS'); ?></h2>
            <p class="nowarning">
            <?php echo JText::_('COM_CIAM_INSTALLATION_THANK'); ?> <strong><?php echo JText::_('COM_CIAM_INSTALLATION_MODULE'); ?></strong>!
            <?php echo JText::_('COM_CIAM_INSTALLATION_CONFIG'); ?> <a href="index.php?option=com_ciamloginradius"><?php echo JText::_('COM_CIAM_INSTALLATION_MODULE'); ?> <?php echo JText::_('COM_CIAM_INSTALLATION_COM'); ?></a>
            <?php echo JText::_('COM_CIAM_INSTALLATION_FREE'); ?> <a href="http://ish.re/1GW6G" target="_blank"><?php echo JText::_('COM_CIAM_INSTALLATION_CONTACT'); ?></a> <?php echo JText::_('COM_CIAM_INSTALLATION_ASSIST'); ?>
                <strong><?php echo JText::_('COM_CIAM_INSTALLATION_THANKYOU'); ?></strong>
            </p>
            <?php
        }
    }
