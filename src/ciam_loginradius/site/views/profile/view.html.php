 ...
 * @since        1.6
 */
class CiamLoginRadiusViewProfile extends JViewLegacy {
    ...
    protected function prepareDocument() {
        ...
        $document->addStyleSheet('components/com_ciamloginradius/assets/css/profile.min.css');
    ...
    public function getInterface($settings) {        
        ...
        //$dispatcher->trigger( 'getCiamOptions', array( $settings ) );
    }    
