...
if ($type == 'logout')
{
    ...
    <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-vertical">
        <div>
            ...
            $avatar = JURI::root() . 'media/com_loginradiussocialloginandsocialshare/images/noimage.png';
            if (!empty($userPicture))
            {
                $avatar = JURI::root() . 'images/sociallogin/' . $userPicture;
            }
            ?>
            <div style="float:left;"><a href="<?php echo 'index.php?option=com_loginradiussocialloginandsocialshare&view=profile'; ?>" title="My Profile">
            ...
            <div>
                <div class="login-greeting">
                    ...
                    <b><?php echo modSocialLoginHelper::socialAccountCount($user, $socialId); ?></b><br/> <?php echo JText::_('MOD_LOGINRADIUS_VALUE_MAPONE'); ?>
                </div>
                <br/>
                <a href="<?php echo 'index.php?option=com_loginradiussocialloginandsocialshare&view=profile'; ?>"><?php echo JText::_('MOD_LOGINRADIUS_VALUE_ACCOUNT'); ?></a>
...
} else
{
    ?>
        ...
        <?php echo modSocialLoginHelper::getInterface($settings);
