...
/**
 * Class SocialLoginAndSocialShareViewSocialLoginAndSocialShare
 */
class SocialLoginAndSocialShareViewSocialLoginAndSocialShare extends JViewLegacy
{
    ...
    private function initialSetting($model)
    {
        ...
        $document->addStyleSheet('components/com_socialloginandsocialshare/assets/css/socialloginandsocialshare' . $version . '.css');
        ...
        $document->addScript('components/com_socialloginandsocialshare/assets/socialloginandsocialshare.php?url=' . urlencode(json_encode($settings['horizontalrearrange']) . '/' . json_encode($settings['verticalrearrange']) . '/' . json_encode($settings['horizontalcounter']) . '/' . json_encode($settings['verticalcounter'])));
