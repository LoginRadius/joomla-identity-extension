                    ...
                    <div id="sharehorizontal" style="display:block;">
                        ...
                        <div style="overflow:auto; background:#FFFFFF; padding:10px;"><span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_HORIZONTAL_THEMES'); ?></span><br/><br/>
                            ...
                            <label for="hori32">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/horizonSharing32.png" ?>'/>
                            </label><br/>
                            <label for="hori16">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/horizonSharing16.png" ?>'/>
                            </label><br/>
                            <label for="responsive">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/responsive-icons.png" ?>'/>
                            </label><br/>
                            <label for="horithemelarge">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/single-image-theme-large.png" ?>'/>
                            </label><br/>
                            <label for="horithemesmall">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/single-image-theme-small.png" ?>'/>
                            </label><br/>
                            <label for="chori16">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/hybrid-horizontal-horizontal.png" ?>'/>
                            </label><br/>
                            <label for="chori32">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/hybrid-horizontal-vertical.png" ?>'/>
                            </label>
                        </div>
                        ...
                        <div style="overflow:auto; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['choosehorizontalshare'], array('4', '5')); ?>;" id="lrhorizontalcounterprovider">
                        ...
                        <div style="overflow:auto; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['choosehorizontalshare'], array('', '0', '1', '6')); ?>;" id="lrhorizontalshareprovider">
                            <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_NETWORKS'); ?></span><br/><br/>
                        ...
                        <div style="overflow:auto; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['choosehorizontalshare'], array('', '0', '1', '6')); ?>;" id="lrhorizontalsharerearange">
                    ...
                    <div id="sharevertical" style="display:none;">
                        ...
                        <div id="verticalsharingtheme" style="overflow:auto; padding:10px;">
                            ...
                            <label for="vertibox32">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/32VerticlewithBox.png" ?>' style="vertical-align:top;"/>
                            </label>
                            <label for="vertibox16">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/16VerticlewithBox.png" ?>' style="vertical-align:top;"/>
                            </label>
                            <label for="cvertibox32">
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/hybrid-verticle-horizontal.png" ?>' style="vertical-align:top;"/>
                                ...
                                <img src='<?php echo "components/com_socialloginandsocialshare/assets/img/hybrid-verticle-vertical.png" ?>' style="vertical-align:top;"/>
                            </label>
                        </div>
                        ...
                        <div style="overflow:auto; background:#FFFFFF; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['chooseverticalshare'], array('2', '3')); ?>;" id="lrverticalcounterprovider">
                            <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_NETWORKS'); ?></span><br/><br/>
                            <div id="countervprovider" class="row_white"></div>
                        </div>
                        <!--social sharing for vertical interface-->
                        <div style="overflow:auto; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['chooseverticalshare'], array('', '1', '0')); ?>;" id="lrverticalshareprovider">
                            <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_NETWORKS'); ?></span><br/><br/>
                        ...
                        <div style="overflow:auto; background:#FFFFFF; padding:10px;display:<?php echo SocialLoginAndSocialShareModelSocialLoginAndSocialShare::selectDisplaySection($this->settings['chooseverticalshare'], array('', '1', '0')); ?>;" id="lrverticalsharerearange">
                            <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_REARRANGE'); ?></span><br><br/>
