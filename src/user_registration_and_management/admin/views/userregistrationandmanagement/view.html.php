...
/**
 * Class UserRegistrationAndManagementViewUserRegistrationAndManagement
 */
class UserRegistrationAndManagementViewUserRegistrationAndManagement extends JViewLegacy
{
    ...
    private function initialSetting($model)
    {
        ...
        $settings['showinterface'] = isset($settings['showinterface']) ? trim($settings['showinterface']) : '1';
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_USERREGISTRATIONANDMANAGEMENT'), 'configuration.gif');
